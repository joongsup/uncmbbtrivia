...
theme_uncmbb2 <- function () {
  # http://www.color-hex.com/color/99badd
  theme_bw(base_size = 12, base_family = "Avenir") %+replace%
    theme(
      plot.background = element_blank(),
      panel.background = element_rect(fill = "#ccdcee", colour = NA),
      #axis.text = element_text(colour = "#99badd"),
      axis.ticks = element_blank(),
      panel.border = element_rect(colour = "#99badd", fill = NA),
  ...
  theme_bw(base_size = 12, base_family = "Avenir") %+replace%
    theme(
     ...
     panel.border = element_rect(colour = "#99badd", fill = NA),
      ...
      panel.grid.major.y = element_line(colour = "#99badd"),
      panel.grid.minor.x = element_blank(),
      panel.grid.minor.y = element_blank()

    )
}
  theme_uncmbb4 <- function () {
  # http://www.color-hex.com/color/99badd
  theme_bw(base_size = 12, base_family = "Avenir") %+replace%
    theme(
      plot.background = element_rect(fill = "transparent", colour = NA),
